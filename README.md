...
The main reporsitory consists of the datasets used as well as the SQL files. The dataset used here is from ourworldindata.org/coronavirus, though the columns have been changed now the dataset uploaded in the repository contains all we need for the data exploration.
